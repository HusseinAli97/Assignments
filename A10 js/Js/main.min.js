...
function showSignIn(){signUpForm.classList.remove("moveUpSignUp"),signInForm.classList.remove("moveDownSignIn"),signUpForm.classList.replace("delay-1","transition-Delay"),signUpBtn.classList.remove("d-none"),backToSignIn.classList.add("d-none")}function showSignUp(){signInForm.classList.add("moveDownSignIn"),signUpForm.classList.add("moveUpSignUp"),signUpForm.classList.replace("transition-Delay","delay-1"),signUpBtn.classList.add("d-none"),backToSignIn.classList.remove("d-none")}function setupLocalStorage(n){localStorage.setItem(localStorageKey,JSON.stringify(n))}function setupEmail(n){localStorage.setItem("isLoggedInEmail",n)}function validName(){const n=signUpNameInput.value.trim();return n?/^[A-Z][a-zA-Z]{3,}$/g.test(n)?accList.some((i=>i.name===n))?(showAlert("This name is already taken. Please choose a different one."),signUpNameInput.classList.add("is-invalid"),!1):(signUpNameInput.classList.contains("is-invalid")?signUpNameInput.classList.remove("is-invalid"):signUpNameInput.classList.add("is-valid"),!0):(showAlert("Invalid name format. Name must start with an uppercase letter and be at least 4 characters long."),signUpNameInput.classList.add("is-invalid"),!1):(showAlert("Name field cannot be empty."),signUpNameInput.classList.add("is-invalid"),!1)}function validEmail(){const n=signUpEmailInput.value.trim();return n?/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(n)?accList.some((i=>i.email===n))?(showAlert("This email is already registered. Please use a different email."),signUpEmailInput.classList.add("is-invalid"),!1):(signUpEmailInput.classList.contains("is-invalid")?signUpEmailInput.classList.remove("is-invalid"):signUpEmailInput.classList.add("is-valid"),!0):(showAlert("Invalid email format. Please enter a valid email address."),signUpEmailInput.classList.add("is-invalid"),!1):(showAlert("Email field cannot be empty."),signUpEmailInput.classList.add("is-invalid"),!1)}function validPassword(){return/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[a-zA-Z]).{8,}$/gm.test(signUpPasswordInput.value)&&""!==signUpPasswordInput.value?(signUpPasswordInput.classList.replace("is-invalid","is-valid"),!0):(signUpPasswordInput.classList.add("is-invalid"),!1)}function validForm(){return validName()&&validEmail()&&validPassword()&&isUniqueName()&&isUniqueEmail()}function handleSignUpFormSubmission(){validForm()&&isUniqueName()&&isUniqueEmail()&&(accList.push({name:signUpNameInput.value,email:signUpEmailInput.value,password:signUpPasswordInput.value}),setupLocalStorage(accList),showSignIn(),clearInput(),showAlert("Successfully signed up!","success"))}function isUniqueName(){const n=signUpNameInput.value;return!accList.some((i=>i.name===n))}function isUniqueEmail(){const n=signUpEmailInput.value;return!accList.some((i=>i.email===n))}function clearInput(){signUpNameInput.value="",signUpEmailInput.value="",signUpPasswordInput.value="",emailInput.value="",passwordInput.value=""}function showAlert(n,i="error"){Swal.fire({icon:i,text:n,position:"bottom",showConfirmButton:!1,timer:3e3,toast:!0})}function showSuccess(n){Swal.fire({icon:"success",title:n,showConfirmButton:!1,timer:1500})}function showLoadingScreen(){document.getElementById("loadingScreen").classList.replace("d-none","d-flex"),setTimeout((function(){window.location.href="../CRUD/index.html"}),3e3)}function validateSignIn(n,i){const s=accList.find((i=>i.email===n));return s?s.password!==i?(showAlert("Incorrect password. Please check your password."),passwordInput.classList.add("is-invalid"),!1):(clearInput(),emailInput.classList.remove("is-invalid"),passwordInput.classList.remove("is-invalid"),!0):(showAlert("Email not found. Please check your email."),emailInput.classList.add("is-invalid"),!1)}signUpBtn.addEventListener("click",(function(){showSignUp()})),backToSignIn.addEventListener("click",(function(){showSignIn()})),signUpNameInput.addEventListener("focusout",(function(){validName()})),signUpEmailInput.addEventListener("focusout",(function(){validEmail()})),signUpPasswordInput.addEventListener("keyup",(function(){validPassword()})),null!==localStorage.getItem(localStorageKey)?(accList=JSON.parse(localStorage.getItem(localStorageKey)),showSignIn()):showSignUp(),null!==localStorage.getItem("isLoggedInEmail")&&showLoadingScreen(),signUpFormBtn.addEventListener("click",handleSignUpFormSubmission),loginMainForm.addEventListener("submit",(function(n){n.preventDefault();const i=emailInput.value.trim();validateSignIn(i,passwordInput.value)&&(showAlert("Successfully signed in!","success"),setupEmail(i),container.classList.add("invisible"),showLoadingScreen())}));